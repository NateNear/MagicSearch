...
const Page = async({searchParams} : PageProps) => {
    ...
    if(products.length === 0){
        return (
            <div className="py-4 bg-white shadow-md rounded-b-md text-center">
                <X className="mx-auto h-8 w-8 text-gray-500"/>
                <p className="mt-2 text-semibold font-bold">No results</p>
                <p className="mt-1 text-gray-600">Sorry, we can't find any items with the name {' '}
